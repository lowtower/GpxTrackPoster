...
def test_get_time_in_seconds() -> None:
    test_times = [
        ('0:00:00',     0), ('12:00:00',     0),
        ('3:00:00', 10800), ('15:00:00', 10800),
        ('6:00:00', 21600), ('18:00:00', 21600),
        ('9:00:00', 32400), ('21:00:00', 32400),
    ]
...
def test_get_clock_angle_from_time() -> None:
    test_times = [
        ('0:00:00',   0.0), ('12:00:00',   0.0),
        ('3:00:00',  90.0), ('15:00:00',  90.0),
        ('6:00:00', 180.0), ('18:00:00', 180.0),
        ('9:00:00', 270.0), ('21:00:00', 270.0),
    ]
    for time_inp, result in test_times:
        time_obj = datetime.strptime(time_inp, "%H:%M:%S").time()
